...
class UserCatalog(Catalog):
    ...
    def modify(self, modified_user):
        ...
        tuple_for_modify_query = (modified_user._first_name, modified_user._last_name, modified_user._physical_address,
                                  modified_user._phone_number, modified_user._email, modified_user._username,
                                  modified_user._password,
...
class BookCatalog(Catalog):
    ...
    def modify(self, modified_book):
        ...
        modified_book._author, modified_book._title, modified_book._format, modified_book._pages,
        modified_book._publisher,
        ...
        if add_to_db is True:
            ...
            if existing_book_id_fetched is None:
                ...
                tuple_for_insert_query = (book._author, book._title, book._format, book._pages,
                                          book._publisher, book._year_of_publication, book._language, book._ISBN10,
                                          book._ISBN13, book._total_quantity, book._quantity_available)
...
class MovieCatalog(Catalog):
        ...
        if add_to_db is True:
            ...
            if existing_movie_id_fetched is None:
                ...
                tuple_for_insert_query = (movie._title, movie._director, movie._producers, movie._actors,
                                          movie._language, movie._subtitles, movie._dubbed,
                                          to_epoch(movie._release_date), movie._runtime, movie._total_quantity,
                                          movie._quantity_available)
    ...
    def modify(self, modified_movie):
        ...
        tuple_for_modify_query = (
        modified_movie._title, modified_movie._director, modified_movie._producers, modified_movie._actors,
        modified_movie._language,
        ...
        if add_to_db is True:
            ...
            if existing_magazine_id_fetched is None:
                ...
                tuple_for_insert_query = (magazine._title, magazine._publisher, magazine._year_of_publication,
                                          ...
                                          magazine._total_quantity, magazine._quantity_available)
            ...
            # else already exist. Need to add new magazine in second table and update quantity of first table
                ...
                tuple_for_updated_quantity_query = (
                magazine._total_quantity, magazine._quantity_available, magazine._id)
    ...
    def add(self, album, add_to_db):
        ...
        if add_to_db is True:
            ...
            if existing_album_id_fetched is None:
                ...
                album._total_quantity, album._quantity_available)
...
class LoanCatalog(Catalog):
    ...
    inv: self._loan_list -> isUnique(id)
    """
    _instance = None
    ...
    def search_transaction(self, search_transaction_key_values, loan_list):
        transformed_dict = {}
        ...
        return helper_functions.search_transaction(transformed_dict, loan_list)
    ...
    def add(self, loan_obj, add_to_db):
        """
        pre:
            self._loan_list -> select(id = loan_object.id) -> size() = 0
        post:
            self._loan_list -> select(id = loan_object.id) -> size() = 1
        """
        self._rwl.start_write()
        ...
        if add_to_db is True:
            ...
            tuple_for_insert_query = (
            loan_obj._user_id, loan_obj._copy_id, loan_obj._table_name, loan_obj._loan_time, loan_obj._due_time, \
