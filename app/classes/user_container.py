class User(object):
    ...
    # This method defines how the object will be printed in the terminal for
    # debugging purposes
    def __repr__(self):
        return 'id: {}, firstName: {}, lastName: {}, physicalAddress: {}, email: {}, phoneNumber: {}, username: {}' \
               ', password: {}, isAdmin: {}, isLogged: {}, lastLogged: {}'\
            .format(self.id, self.firstName, self.lastName, self.physicalAddress, self.email, self.phoneNumber, self.username, self.password, self.isAdmin, self.isLogged, self.lastLogged)
